...
def get_database():
    try:
        ...
        engine = get_engine(config.PGDATABASE, config.PGUSER, config.PGHOST, config.PGPORT, config.PGPASSWORD)
...
# =============================================================================
# def get_connection_from_profile(config_file_name="config.py"):
#     """
